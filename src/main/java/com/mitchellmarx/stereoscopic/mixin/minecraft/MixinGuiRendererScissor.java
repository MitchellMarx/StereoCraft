 ...
 * {@link MixinGuiRenderer}'s {@code perEyeHudTransform} do. The model-view
 * compression places each eye's GUI geometry in a half chosen with swap taken
 * into account; if the scissor picks the half WITHOUT swap, the two disagree
 * under swap and the scissor clips the compressed geometry off the opposite
 * half. All scissored GUI content (e.g. Sodium's scrollable options list) then
 * vanishes — the reported "config menu disappeared after enabling eye-swap".
 *
