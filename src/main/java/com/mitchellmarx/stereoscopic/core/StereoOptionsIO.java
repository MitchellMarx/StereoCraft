    ...
    public static void readInto(Path path, StereoOptions target) {
        ...
        try {
            ...
            if (obj.has("ipd")) {
                ...
                // Range MUST match the GUI slider in StereoOptionsPage (55-100 mm).
                // If this clamp is narrower than the slider, values the user set
                // above the clamp get silently snapped back on the next startup —
                // the setting appears not to "stick".
