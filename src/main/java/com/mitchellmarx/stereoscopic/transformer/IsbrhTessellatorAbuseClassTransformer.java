package com.mitchellmarx.stereoscopic.transformer;

import com.gtnewhorizons.angelica.loading.shared.AngelicaClassDump;
import com.mitchellmarx.stereoscopic.loading.StereoscopicCoreMod;
...
public class IsbrhTessellatorAbuseClassTransformer implements IClassTransformer {
    private static final Logger LOGGER = LogManager.getLogger("StereoscopicIsbrhTransformer");
    ...
    public IsbrhTessellatorAbuseClassTransformer() {
        this(StereoscopicCoreMod.OBF_ENV);
        // Latest hook within the FML coremod lifecycle before classes start loading. Retries
        // the cursor-package exclusion install in case the earlier coremod-ctor and injectData
        // attempts both ran before RFB had populated its transformer-handle list.
        StereoscopicCoreMod.addCursorPackageToRedirectorExclusions("isbrh-transformer-ctor");
    }
